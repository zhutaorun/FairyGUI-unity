...
/**
 * Use to load icons, and pool them
 */
public class IconManager : MonoBehaviour
{
	...
	public IconManager()
	{
		...
		_pool = new Hashtable();
		_basePath = Application.streamingAssetsPath.Replace("\\", "/") + "/icons/";
	...
	{
		yield return new WaitForSeconds(30); //check the pool every 30 seconds
